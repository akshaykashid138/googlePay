    ...
    const Final = () => {
        ...
        function payClicked(){
            ...
            axios.post("https://nbupayments.googleapis.com/v1/merchantPayments:initiate",
            {
            
                // googleMerchantId should be set. This ID is globally unique across all Google Pay merchants.
                merchantInfo: {
                        googleMerchantId: "BCR2DN6TZ76K7GKI"
                },
                userInfo: {
                        // Phone no. of the payer in E.164 format
                        phoneNumber: "+917887709470"
                },
                merchantTransactionDetails: {
                    ...
                    invoice: {
                        ...
                        invoiceTime: "2021-07-25T13:50:30Z"
                    }
                },
                ...
                expiryTime: "2021-07-26T10:50:30Z",
